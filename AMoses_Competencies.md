...
##### MongoDB
*Relational database uses tables with columns as properties, document based database uses a document and does not have set properties of an object like columns in a relational database. Ex here: https://github.com/amoses12/MongoEx*
